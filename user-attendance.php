...
$sql_logs = "SELECT l.*, u.first_name, u.last_name
             FROM accesslogs l
             LEFT JOIN users u ON l.user_id = u.user_id WHERE u.user_id = $user_id AND access_granted = 1
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-content">
                <ul class="sidebar-nav">
                    <li>
                        <a href="./user-dashboard.php" class="nav-link "> <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="./user-attendance.php" class="nav-link active"> <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                            <span>Attendace</span>
                        </a>
