...
// Bind parameters if any exist for the WHERE clause
if (!empty($params)) {
...
<body>
    ...
    <div class="dashboard-layout" id="dashboard-layout" style="visibility: hidden;"> <nav class="navbar">
            ...
            <div class="main-content-inner">
                ...
                <div class="content-grid">
                   <div class="card">
                        ...
                        <p>View access logs and manage users.</p>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="stats-item" style="margin-top: 1rem;">
                            ...
                            <div class="stats-text">
                                <p>Filtered Access Logs (Total)</p>
                                <p><?= $total_records ?></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody id="logTableBody">
                            ...
                            if ($result_logs && mysqli_num_rows($result_logs) > 0) {
                                while ($row = mysqli_fetch_assoc($result_logs)) {
                                    ...
                                    $rfid_scanned = htmlspecialchars($row['rfid_scanned']);
                                ...
                                echo '<tr><td colspan="5" style="text-align: center; padding: 1rem;">No matching access logs found for the selected criteria.</td></tr>';
                            }
            ...
            if (searchInput && tableBody) {
                searchInput.addEventListener('input', () => {
                    ...
                    for (let i = 0; i < tableRows.length; i++) {
                        ...
                        } else if (row.getElementsByTagName('td').length === 1) {
                             row.style.display = 'none';
                        }
                    }
                });
